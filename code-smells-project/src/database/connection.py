...
def _seed_if_empty(conn):
    ...
    usuarios = [
        ("Admin", "admin@loja.com", hash_senha("admin123"), "admin"),
        ("João Silva", "joao@email.com", hash_senha("123456"), "cliente"),
        ("Maria Santos", "maria@email.com", hash_senha("senha123"), "cliente"),
    ]
    cur.executemany(
